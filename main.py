from image import GeminiImageDescriber
import os
...
def main():
    ...
    for filename in os.listdir(samples_dir):
        if filename.lower().endswith((".jpg", ".jpeg", ".png")):
            ...
            print(f"\nBild: {filename}")
            try:
                description = describer.describe_image(image_path, prompt=prompt)
                print(description)
            except Exception as e:
                print("Error:", e)

if __name__ == "__main__":
    print("Kartenname;Edition;Kartennummer;Sprache;Verlag;Erscheinungsjahr;Region;Seltenheit;Kartentyp;Subtyp;Farbe;Spezialeffekte;Limitierung;Autogramm;Memorabilia;Zustand;Ankaufspreis;Marktwert")
    main()


#Kartenname;Edition;Kartennummer;Sprache;Verlag;Erscheinungsjahr;Region;Seltenheit;Kartentyp;Subtyp;Farbe;Spezialeffekte;Limitierung;Autogramm;Memorabilia;Zustand;Ankaufspreis;Marktwert
